    ...
    <>
      ...
      <div className="container px-5 py-24 mx-auto cursor-pointer">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt={product && product[0]?.title} className="lg:w-auto w-[40vh] lg:h-[70vh] h-auto object-cover object-center rounded cursor-pointer" src={product && product[0].imageUrl} />
